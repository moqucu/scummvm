...
bool Debugger::cmdHelp(int argc, const char **argv) {
	...
	static const HelpEntry HELP_TABLE[] = {
		...
		{ "down",            "down",                                 "Move down one dungeon floor (max depth 7)" },
		{ "dungeon",         "dungeon <1-11>",                       "Teleport to dungeon 1-8 (main) or 9-11 (Deceit/Despise/Destard); world map only" },
		...
		{ "goto",            "goto <name|portal_num|label>",         "Teleport by location name, portal index, or map label" },
		...
		{ "location",        "location [x y]",                       "Display or set coordinates; accepts letter-pairs (AA BB) or numbers" },
		...
		{ "teleport",        "teleport <name|portal_num|label>",     "Alias for goto" },
		...
		{ "up",              "up",                                   "Move up one dungeon floor" },
